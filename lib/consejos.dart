...
class ConsejosProvider {
  static final List<String> _consejos = [
    ...
    "Se conoce como 'Scroll Infinito' al acto de consumir indefinidamente contenido en apps como Instagram, Facebook, o Tiktok",
    ...
    "Si no puedes parar de bajar en una app, puedes imaginarte algo que muy probablemente te encuentres pronto, y forzarte a dejar de hacerlo cuando eso ocurra",
